...
/// Wellness profile shell — cover, header, tabs below bio, tab content.
        ...
        headerSliverBuilder: (context, innerBoxIsScrolled) {
          return [
            ...
            SliverPersistentHeader(
              pinned: true,
              delegate: _WellnessTabBarHeaderDelegate(tabBar: _buildTabBar()),
            ),
          ];
        },
        body: ColoredBox(
...
class _WellnessTabBarHeaderDelegate extends SliverPersistentHeaderDelegate {
  final Widget tabBar;

  _WellnessTabBarHeaderDelegate({required this.tabBar});
  ...
  @override
  bool shouldRebuild(covariant _WellnessTabBarHeaderDelegate oldDelegate) {
